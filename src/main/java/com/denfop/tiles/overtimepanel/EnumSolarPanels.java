...
public enum EnumSolarPanels {
    ...
    ADVANCED_SOLAR_PANEL(null, IUItem.blockpanel, 0, TileEntityAdvancedSolarPanel.class, !Config.advloaded ?"Advanced Solar Panel" :"Advanced Solar Panel IU" , "IUBlockAdvancedSolarPanel.name", 1, Config.advGenDay, Config.advStorage, Config.advOutput, true, "default", "asp_top", true),
    HYBRID_SOLAR_PANEL(ADVANCED_SOLAR_PANEL, IUItem.blockpanel, 1, TileEntityHybridSolarPanel.class, !Config.advloaded ?"Hybrid Solar Panel" : "Hybrid Solar Panel IU", "IUBlockHybridSolarPanel.name", 2, Config.hGenDay, Config.hStorage, Config.hOutput, true, "default", "hsp_top", true),
    PERFECT_SOLAR_PANEL(HYBRID_SOLAR_PANEL, IUItem.blockpanel, 2, TileEntityPerfectSolarPanel.class, !Config.advloaded ?"Perfect Solar Panel" : "Perfect Solar Panel IU ", "IUBlockUltimateSolarPanel.name", 3, Config.uhGenDay, Config.uhStorage, Config.uhOutput, true, "default", "usp_top", true),
    QUANTUM_SOLAR_PANEL(PERFECT_SOLAR_PANEL, IUItem.blockpanel, 3, TileEntityQuantumSolarPanel.class, !Config.advloaded ?"Quantum Solar Panel" : "Quantum Solar Panel IU", "IUBlockQuantumSolarPanel.name", 4, Config.qpGenDay, Config.qpStorage, Config.qpOutput, true, "default", "qsp_top", true),
    SPECTRAL_SOLAR_PANEL(QUANTUM_SOLAR_PANEL, IUItem.blockpanel, 4, TileEntitySpectralSolarPanel.class, !Config.iu_old_loaded ? "Spectral Solar Panel" : "Spectral Solar Panel IU", "IUBlockSpectralSolarPanel.name", 5, Config.spectralpanelGenDay, Config.spectralpanelstorage, Config.spectralpanelOutput, true, "default", "spsp_top", true),
    PROTON_SOLAR_PANEL(SPECTRAL_SOLAR_PANEL, IUItem.blockpanel, 5, TileEntityProtonSolarPanel.class, !Config.iu_old_loaded ? "Proton Solar Panel" : "Proton Solar Panel IU" ,  "IUBlockProtonSolarPanel.name", 6, Config.protongenDay, Config.protonstorage, Config.protonOutput, true, "default", "psp_top", true),
    SINGULAR_SOLAR_PANEL(PROTON_SOLAR_PANEL, IUItem.blockpanel, 6, TileEntitySingularSolarPanel.class, !Config.iu_old_loaded ? "Singular Solar Panel" : "Singular Solar Panel IU" , "IUBlockSingularSolarPanel.name", 7, Config.singularpanelGenDay, Config.singularpanelstorage, Config.singularpanelOutput, true, "default", "ssp_top", true),
    DIFFRACTION_SOLAR_PANEL(SINGULAR_SOLAR_PANEL, IUItem.blockpanel, 7, TileEntityDiffractionSolarPanel.class, !Config.iu_old_loaded ? "Diffraction Solar Panel" :"Diffraction Solar Panel IU", "IUBlockAdminSolarPanel.name", 8, Config.adminpanelGenDay, Config.AdminpanelStorage, Config.AdminpanelOutput, true, "default", "admsp_model", true),
    PHOTONIC_SOLAR_PANEL(DIFFRACTION_SOLAR_PANEL, IUItem.blockpanel, 8, TileEntityPhotonicSolarPanel.class, !Config.iu_old_loaded ? "Photon Solar Panel" : "Photon Solar Panel IU", "IUBlockPhotonicSolarPanel.name", 9, Config.photonicpanelGenDay, Config.photonicpanelStorage, Config.photonicpanelOutput, true, "default", "phsp_top", true),
    NEUTRONIUN_SOLAR_PANEL(PHOTONIC_SOLAR_PANEL, IUItem.blockpanel, 9, TileEntityNeutronSolarPanel.class, !Config.iu_old_loaded ? "Neutron Solar Panel" : "Neutron Solar Panel IU", "IUBlockNeutronSolarPanel.name", 10, Config.neutronpanelGenDay, Config.neutronpanelStorage, Config.neutronpanelOutput, true, "default", "nsp_top", true),
    BARION_SOLAR_PANEL(NEUTRONIUN_SOLAR_PANEL, IUItem.blockpanel, 10, TileEntityBarionSolarPanel.class, "Barion Solar Panel", "IUBlockBarionSolarPanel.name", 11, Config.barGenDay, Config.barStorage, Config.barOutput, true, "default", "bsp_top", true),
    HADRON_SOLAR_PANEL(BARION_SOLAR_PANEL, IUItem.blockpanel, 11, TileEntityHadronSolarPanel.class, "Hadron Solar Panel", "IUBlockAdronSolarPanel.name", 12, Config.adrGenDay, Config.adrStorage, Config.adrOutput, true, "default", "adsp_top", true),
    GRAVITON_SOLAR_PANEL(HADRON_SOLAR_PANEL, IUItem.blockpanel, 12, TileEntityGravitonSolarPanel.class, "Graviton Solar Panel", "IUBlocGravitonSolarPanel.name", 13, Config.graGenDay, Config.graStorage, Config.graOutput, true, "default", "grasp_top", true),
    KVARK_SOLAR_PANEL(GRAVITON_SOLAR_PANEL, IUItem.blockpanel, 13, TileEntityQuarkSolarPanel.class, "Kvark Solar Panel", "IUBlockKvarkSolarPanel.name", 14, Config.kvrGenDay, Config.kvrStorage, Config.kvrOutput, true, "default", "kvsp_top", true),
    NEUTRONIUM_SOLAR_PANEL_AVARITIA(PHOTONIC_SOLAR_PANEL, Config.AvaritiaLoaded && Config.Avaritia ? AvaritiaIntegration.blockAvSolarPanel : null, 0, com.denfop.integration.avaritia.TileEntityNeutronSolarPanel.class, "Neutron Solar Panel Avaritia", "IUBlockNeutronSolarPanelAvaritia.name", Config.tier, Config.neutrongenday, Config.neutronStorage, Config.neutronOutput, Config.AvaritiaLoaded && Config.Avaritia, "avaritia", "neutronium_top", false),
